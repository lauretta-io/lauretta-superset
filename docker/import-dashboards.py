    ...
    sql_template = """
        ...
        main_query AS (
            SELECT
                    ...
                    res.category,
                    res.points,
                    -- res.footfall_zo AS total_footfall,
                    -- ROUND(
                    --     100 * (
                    --         res.footfall_zo::NUMERIC
                    ...
                    ROUND(
                        100 * (
                            res.footfall_reid::NUMERIC
                            / NULLIF(property_footfall.prop_footfall_reid::NUMERIC, 0)
                        ),
                        2
                    ) AS percentage_of_prop,
                    COALESCE(
            ...
            FROM (
                    ...
                    SELECT
                        ...
                        z.points,
                        COALESCE(us.footfall_zo, 0) AS footfall_zo,
                        COALESCE(us.footfall_reid, 0) AS footfall_reid,
                        us.event_time
                    FROM (
                        SELECT
                        unit_id,
                    ...
                    LEFT JOIN property.units u on u.id = us.unit_id
                    LEFT JOIN property.unit_zone_mappings uzm ON uzm.unit_id = u.id
                    LEFT JOIN property.zones z on z.id = uzm.zone_id
                    ...
                    SELECT
                        ...
                        'Public' AS category,
                        z.points,
                        COALESCE(pss.footfall_zo, 0) AS footfall_zo,
                        COALESCE(pss.footfall_reid, 0) AS footfall_reid,
                        pss.event_time
                    FROM (
                        SELECT
                        public_space_id,
                    ...
                    LEFT JOIN property.public_spaces ps ON ps.id = pss.public_space_id
                    ...
                    SELECT
                        ...
                        z.points,
                        COALESCE(ens.footfall_zo, 0) AS footfall_zo,
                        COALESCE(ens.footfall_reid, 0) AS footfall_reid,
                        ens.event_time
                    FROM (
                        SELECT
                        entrance_id,
                    ...
                    LEFT JOIN property.entrances en ON en.id = ens.entrance_id
                    LEFT JOIN property.entrance_zone_mappings enzm ON enzm.entrance_id = en.id
                    LEFT JOIN property.zones z ON z.id = enzm.zone_id
                    UNION ALL
                    -- Escalators
                    SELECT
                        z.floor_id,
                        ...
                        z.points,
                        COALESCE(ess.footfall_zo, 0) AS footfall_zo,
                        COALESCE(ess.footfall_reid, 0) AS footfall_reid,
                        ess.event_time
                    FROM (
                        SELECT
                        escalator_id,
                    ...
                    LEFT JOIN property.escalators es ON es.id = ess.escalator_id
                    LEFT JOIN property.escalator_zone_mappings eszm ON eszm.escalator_id = es.id
                    LEFT JOIN property.zones z ON z.id = eszm.zone_id
                    UNION ALL
                    -- Lift Lobbies
                    SELECT
                        z.floor_id,
                        ...
                        'Circulation' AS category,
                        z.points,
                        COALESCE(lls.footfall_zo, 0) AS footfall_zo,
                        COALESCE(lls.footfall_reid, 0) AS footfall_reid,
                        lls.event_time
                    FROM (
                        SELECT
                        lift_lobby_id,
                    ...
                    LEFT JOIN property.lift_lobbies ll ON ll.id = lls.lift_lobby_id
