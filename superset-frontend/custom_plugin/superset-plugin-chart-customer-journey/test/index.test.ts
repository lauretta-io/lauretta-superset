 ...
 * under the License.
 */
import { SupersetPluginChartCustomerJourney } from '../src';
 ...
 */
describe('superset-plugin-chart-customer-journey', () => {
  it('exists', () => {
    expect(SupersetPluginChartCustomerJourney).toBeDefined();
  });
});
